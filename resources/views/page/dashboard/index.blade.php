                ...
                <div class="card avtivity-card">
                    <div class="card-body">
                        ...
                        <div class="progress" style="height:5px;">
                            <div class="progress-bar bg-success" style="width: {{ $t == 0 ? 0 : ($h/$t) * 100 }}%; height:5px;" role="progressbar">
                                <span class="sr-only">{{ $t == 0 ? 0 : ($h/$t) * 100 }}% Complete</span>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-sm-6">
                <div class="card avtivity-card">
                    <div class="card-body">
                        ...
                        <div class="progress" style="height:5px;">
                            <div class="progress-bar bg-secondary" style="width: {{ $t == 0 ? 0 : ($i/$t) * 100 }}%; height:5px;" role="progressbar">
                                <span class="sr-only">{{ $t == 0 ? 0 : ($i/$t) * 100 }}% Complete</span>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-sm-6">
                <div class="card avtivity-card">
                    <div class="card-body">
                        ...
                        <div class="progress" style="height:5px;">
                            <div class="progress-bar bg-danger" style="width: {{ $t == 0 ? 0 : ($s/$t) * 100 }}%; height:5px;" role="progressbar">
                                <span class="sr-only">{{ $t == 0 ? 0 : ($s/$t) * 100 }}% Complete</span>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-sm-6">
                <div class="card avtivity-card">
                    <div class="card-body">
                        ...
                        <div class="progress" style="height:5px;">
                            <div class="progress-bar bg-warning" style="width: {{ $t == 0 ? 0 : ($c/$t) * 100 }}%; height:5px;" role="progressbar">
                                <span class="sr-only">{{ $t == 0 ? 0 : ($c/$t) * 100 }}% Complete</span>
                            </div>
                        </div>
                    </div>
